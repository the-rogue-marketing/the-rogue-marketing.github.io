...
const MODELS = {
  google: {
    ...
    models: [
      ...
      { id:"gemini-3.1-pro-customtools", name:"Gemini 3.1 Pro (Custom Tools)", input:2.00, output:12.00, cachedInput:0.50, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"flagship" },
      ...
      { id:"gemini-3.1-flash-live-preview", name:"Gemini 3.1 Flash Live (Audio-to-Audio)", input:0.50, output:3.00, cachedInput:0.125, context:1000000, img:true, aud:true, vid:true, batch:false, tier:"balanced" },
      { id:"gemini-3.1-flash-image-preview", name:"Gemini 3.1 Flash Image (Gen)", input:0.50, output:60.00, cachedInput:0.125, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"balanced" },
      { id:"gemini-3.1-flash-tts-preview", name:"Gemini 3.1 Flash TTS (Speech)", input:0.50, output:3.00, cachedInput:0.125, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"balanced" },
      ...
      { id:"gemini-3-pro-image-preview", name:"Gemini 3 Pro Image (Gen)", input:2.00, output:120.00, cachedInput:0.50, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
