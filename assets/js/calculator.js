...
const MODELS = {
  google: {
    ...
    icon: "🔷",
    models: [
      { id:"gemini-3.5-flash", name:"Gemini 3.5 Flash", input:0.50, output:3.00, cachedInput:0.05, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"flagship" },
      { id:"gemini-3.1-pro", name:"Gemini 3.1 Pro", input:1.25, output:5.00, cachedInput:0.125, inputLong:2.50, outputLong:10.00, longThreshold:128000, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"flagship" },
      { id:"gemini-3.1-pro-customtools", name:"Gemini 3.1 Pro (Custom Tools)", input:1.25, output:5.00, cachedInput:0.125, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"flagship" },
      { id:"gemini-3.1-flash-lite", name:"Gemini 3.1 Flash-Lite", input:0.075, output:0.30, cachedInput:0.0075, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"budget" },
      { id:"gemini-3.1-flash-live-preview", name:"Gemini 3.1 Flash Live (Audio-to-Audio)", input:0.075, output:0.30, cachedInput:0.0075, context:1000000, img:true, aud:true, vid:true, batch:false, tier:"balanced" },
      { id:"gemini-3.1-flash-image-preview", name:"Gemini 3.1 Flash Image (Gen)", input:0.075, output:6.00, cachedInput:0.0075, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"balanced" },
      { id:"gemini-3.1-flash-tts-preview", name:"Gemini 3.1 Flash TTS (Speech)", input:0.075, output:0.30, cachedInput:0.0075, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"balanced" },
      { id:"gemini-3-flash", name:"Gemini 3 Flash", input:0.075, output:0.30, cachedInput:0.0075, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"balanced" },
      { id:"gemini-3-pro-image-preview", name:"Gemini 3 Pro Image (Gen)", input:1.25, output:5.00, cachedInput:0.125, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
      ...
      { id:"gemini-2.5-flash-lite-preview-09-2025", name:"Gemini 2.5 Flash-Lite (Preview 09-2025)", input:0.10, output:0.40, cachedInput:0.025, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"budget" },
      { id:"gemini-2.5-flash-native-audio", name:"Gemini 2.5 Flash Live Audio", input:0.30, output:2.50, cachedInput:0.075, context:1000000, img:true, aud:true, vid:false, batch:false, tier:"legacy" },
      { id:"gemini-2.5-flash-image", name:"Gemini 2.5 Flash Image", input:0.30, output:30.00, cachedInput:0.075, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"legacy" },
      { id:"gemini-2.5-computer-use-preview", name:"Gemini 2.5 Computer Use", input:1.25, output:10.00, cachedInput:0.3125, context:1000000, img:true, aud:false, vid:false, batch:false, tier:"flagship" },
      { id:"gemini-embedding-2", name:"Gemini Embedding 2", input:0.10, output:0.00, cachedInput:0.025, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"balanced" },
      { id:"gemini-robotics-er-1.6", name:"Gemini Robotics-ER 1.6", input:2.00, output:12.00, cachedInput:0.50, context:1000000, img:true, aud:true, vid:true, batch:true, tier:"flagship" }
    ],
    imageTokens: 258,
  ...
  openai: {
    ...
    icon: "🟢",
    models: [
      { id:"gpt-5.5-pro", name:"GPT-5.5 Pro", input:5.00, output:15.00, cachedInput:2.50, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
      { id:"gpt-5.5-instant", name:"GPT-5.5 Instant", input:2.50, output:7.50, cachedInput:1.25, context:500000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
  ...
  xai: {
    ...
    icon: "⚡",
    models: [
      { id:"grok-4.3", name:"Grok 4.3", input:2.00, output:10.00, cachedInput:1.00, context:1000000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
      { id:"grok-4.20", name:"Grok 4.20", input:2.00, output:10.00, cachedInput:1.00, context:2000000, img:true, aud:false, vid:false, batch:true, tier:"flagship" },
